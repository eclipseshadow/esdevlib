...
/**
 * Halp Submit Field Class
 *
 * Creates an HTML <input type="submit"/> element
 */
class Halp_Form_Field_Submit extends Halp_Form_Field {
	
	/**
	 * Constructor method for the Halp Submit Field object
	 * 
